...
pub mod test_utils {
    ...
    pub fn setup_basic_test_env(
        test_name: &str,
    ) -> Result<(PassWalletManager, String, Vec<String>)> {
        ...
        let trading_subaccount =
            create_test_subaccount("trading", "Trading Account", &wallet_address);

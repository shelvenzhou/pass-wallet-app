...
impl BenchmarkEnvironment {
    ...
    fn setup_initial_balance(&self, amount: u64) -> Result<()> {
        ...
        self.manager.claim_inbox(&self.wallet_address, "initial_setup", &self.subaccount_id)?;
...
mod benchmark_tests {
    ...
    fn benchmark_wallet_creation() -> Result<()> {
        ...
        assert!(result.operations_per_second > 10.0, 
                "Wallet creation too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_claim_operations() -> Result<()> {
        ...
        assert!(result.operations_per_second > 100.0,
                "Claim operations too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_transfer_operations() -> Result<()> {
        ...
        env.manager.add_subaccount(&env.wallet_address, trading_subaccount)?;
        ...
        assert!(result.operations_per_second > 500.0,
                "Transfer operations too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_withdraw_operations() -> Result<()> {
        ...
        // Assert reasonable performance
        assert!(result.operations_per_second > 500.0,
                "Withdraw operations too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_balance_queries() -> Result<()> {
        ...
        assert!(result.operations_per_second > 10000.0,
                "Balance queries too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_concurrent_operations() -> Result<()> {
        ...
        println!("Benchmarking concurrent operations with {} threads...", num_threads);
    ...
    fn benchmark_end_to_end_workflow() -> Result<()> {
        ...
        assert!(result.operations_per_second > 10.0,
                "End-to-end workflow too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_provenance_queries() -> Result<()> {
        ...
        for i in 0..100 {
            ...
            env.manager.inbox_deposit(&env.wallet_address, deposit)?;
            env.manager.claim_inbox(&env.wallet_address, &format!("prov_deposit_{}", i), &env.subaccount_id)?;
        }
        ...
        assert!(result.operations_per_second > 1000.0,
                "Provenance queries too slow: {} ops/sec", result.operations_per_second);
    ...
    fn benchmark_memory_usage() -> Result<()> {
        ...
        for i in 0..large_dataset_size {
            ...
            env.manager.inbox_deposit(&env.wallet_address, deposit)?;
            env.manager.claim_inbox(&env.wallet_address, &format!("memory_test_{}", i), &env.subaccount_id)?;
